...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(context, (self.state != UIControlStateHighlighted) ? BALLER_CORLOR_NAVIGATIONBAR.CGColor : SELECTED_TEXT_COLOR.CGColor);
...
- (void)buildControl {
    ...
    [barSel setBackgroundColor:BALLER_CORLOR_NAVIGATIONBAR];
