...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < dayTitles.count; i++) 
    {
        ...
        [((NSString *)[dayTitles objectAtIndex:index])  drawInRect:dayHeaderFrame withAttributes:@{NSFontAttributeName:calendarFont,NSParagraphStyleAttributeName:textStyle,NSForegroundColorAttributeName:[UIColor whiteColor]}];
    ...
    textStyle.alignment = NSTextAlignmentCenter;
    [monthTitle drawInRect:textFrame withAttributes:@{NSFontAttributeName:monthFont,NSForegroundColorAttributeName:[UIColor whiteColor],NSParagraphStyleAttributeName:textStyle}];
    CGContextRestoreGState(context);
...
- (void)drawRect:(CGRect)rect
{
    ...
    void (^drawString)(NSString *, CGRect, UIColor *) = ^(NSString *string, CGRect rect, UIColor *color) {
        ...
        textStyle.alignment = NSTextAlignmentCenter;
        textStyle.lineBreakMode = NSLineBreakByWordWrapping;
        [string drawInRect:rect withAttributes:@{NSFontAttributeName:self.font,NSForegroundColorAttributeName:color,NSParagraphStyleAttributeName:textStyle}];
        CGContextRestoreGState(context);
    };
